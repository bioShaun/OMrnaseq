...
red_label <- paste("Up-regulated genes:",red_count,sep = " ")
green_label <- paste("Down regulated genes:",green_count,sep = " ")
#brewer for color
...
ggsave(filename=paste(out_dir,"/",name,".png",sep=""),type="cairo-png",plot=p,width = 8,height = 6)
